...
class AsyncTeleBot:
    ...
    async def process_new_managed_bots(self, new_managed_bots):
        """
        :meta private:
        """
    ...
    async def send_rich_message(
        ...
        :param message_thread_id: Unique identifier for the target message thread (topic) of a forum; for forum supergroups
    ...
    async def answer_chat_join_request_query(self, chat_join_request_query_id: str, result: str) -> bool:
        """
        ...
        :param result: Result of the query. Must be either “approve” to allow the user to join the chat, “decline”
        ...
        :rtype: :obj:`bool`
        """
        return await asyncio_helper.answer_chat_join_request_query(self.token, chat_join_request_query_id, result)

    async def send_chat_join_request_web_app(self, chat_join_request_query_id: str, web_app_url: str) -> bool:
        """
        ...
        :rtype: :obj:`bool`
        """
        return await asyncio_helper.send_chat_join_request_web_app(self.token, chat_join_request_query_id, web_app_url)
    ...
    async def set_managed_bot_access_settings(self, user_id: int, is_access_restricted: bool,
        ...
        :rtype: :obj:`bool`
        """
        return await asyncio_helper.set_managed_bot_access_settings(self.token, user_id, is_access_restricted, added_user_ids=added_user_ids)
